...
export default function PrivacyPolicyScreen() {
  const text = `We respect your privacy. This policy explains how we collect, use, and protect your information when you use BeeXpay.`;
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF', display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '15px 20px', borderBottom: '1px solid #F0F0F0', width: '100%' }}>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 500, color: '#000', margin: 0, textAlign: 'center', flex: 1 }}>Privacy Policy</h2>
        <div style={{ width: 24 }} />
      </div>
